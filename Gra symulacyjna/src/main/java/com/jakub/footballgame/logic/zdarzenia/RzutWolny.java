...
public class RzutWolny extends ZdarzeniaZakonczoneStrzalem {
	...
	public RzutWolny(NazwaDruzyny druzynaAtakujaca, NazwaDruzyny druzynaBroniaca, int numerGraczaStrzelajacego, int silaStrzelca, int silaBramkarza) {
	...
	public IEfekt efektZdarzenia() {
		...
		if (randomNumer < 2) return new Gol(this.getDruzynaAtakujaca(), this.getNumerGraczaStrzelajacego());
